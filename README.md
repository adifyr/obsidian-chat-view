...
3. You may set the `Self` parameter in your metadata to a specific name. All chat bubbles from that name will appear on the right hand side as opposed to the default, which is left, to indicate that this person's chats are in First-Person.
